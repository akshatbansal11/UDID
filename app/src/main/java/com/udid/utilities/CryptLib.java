...
import static com.udid.utilities.CryptUniqueIdGenerator.getCryptUniqueId;
...
//    private final String CRYPT_KEY = "GM2SO0DB2MD0TECV";
    private final String CRYPT_IV = "GTC2SRE0DAN2MIT0TNECIRNG";
    ...
    public CryptLib() throws NoSuchAlgorithmException, NoSuchPaddingException {
        ...
        _cx = Cipher.getInstance(AES_ALGORITHM_TYPE);
    ...
    public String EncryptString(String _plainText)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException, NoSuchAlgorithmException {
        return EncryptString(_plainText, getCryptUniqueId());
    }

    public String EncryptString(String _plainText, String cryptKey)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException, NoSuchAlgorithmException {
        String k = cryptKey;
    ...
    public String DecryptString(String _plainText)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException, NoSuchAlgorithmException {
        return DecryptString(_plainText, getCryptUniqueId());
    }

    public String DecryptString(String _plainText, String cryptKey)
            throws InvalidKeyException, UnsupportedEncodingException,
            InvalidAlgorithmParameterException, IllegalBlockSizeException,
            BadPaddingException, NoSuchAlgorithmException {
        String k = cryptKey;

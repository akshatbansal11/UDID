...
import com.swavlambancard.udid.databinding.ActivityUpdateEmailIdBinding
...
class UpdateEmailIDActivity : BaseActivity<ActivityUpdateEmailIdBinding>() {
    ...
    override fun setVariables() {
        mBinding?.etCurrentEmailId?.text =if(getPreferenceOfLogin(
                this,
                AppConstants.LOGIN_DATA,
                UserData::class.java
            ).email.isNullOrEmpty()) getString(R.string.na) else

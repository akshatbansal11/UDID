...
import com.swavlambancard.udid.databinding.ActivityUpdateAadharNumberBinding
...
import com.swavlambancard.udid.utilities.Utility.maskAadharNumber
...
class UpdateAadharNumberActivity : BaseActivity<ActivityUpdateAadharNumberBinding>() {
    ...
    override fun setVariables() {
        mBinding?.etCurrentAadhaarNumber?.text = if(getPreferenceOfLogin(
                this,
                AppConstants.LOGIN_DATA,
                UserData::class.java
            ).aadhaar_no.isNullOrEmpty()) getString(R.string.na) else
            maskAadharNumber(
